...
o estado atual do OpenClaw como framework e runtime operacional.
...
para verificar se a implementacao atual do OpenClaw Framework v3.0 esta
coerente, consistente e operacionalmente correta.
...
3. Trate `legacy_reference`, `historical` e arquivos em
   `PROJETOS/COMUM/LEGADO/` como legado arquivado.
...
7. Se o runtime operacional do indice e realmente Postgres:
   - `OPENCLAW_PROJECTS_DATABASE_URL` tratado como variavel operacional
