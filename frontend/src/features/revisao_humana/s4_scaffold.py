    ...
    response = S4WorkbenchScaffoldResponse(
        ...
        pontos_integracao={
            ...
            "workbench_revisao_s4_core_module": (
                "frontend.src.features.revisao_humana.s4_core.execute_workbench_revisao_s4_main_flow"
            ),
            "workbench_revisao_s4_validation_module": (
                "frontend.src.features.revisao_humana.s4_validation.validate_workbench_revisao_s4_output_contract"
            ),
        },
    )
    logger.info(
