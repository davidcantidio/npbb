...
- [x] Modelo `ConversaoAtivacao` (ou equivalente) com: id, ativacao_id, lead_id, cpf, created_at
- [x] Modelo `LeadReconhecimentoToken` com: lead_id, evento_id, token_hash, expires_at
- [x] Migrations aplicáveis em banco limpo e com dados existentes
- [x] Rollback das migrations sem efeito colateral
- [x] Testes de criação/leitura dos modelos passam
...
| ISSUE-F1-01-002 | Modelos conversao_ativacao e lead_reconhecimento_token | Criar modelos e migrations para conversão e token de reconhecimento | 3 | done | [ISSUE-F1-01-002-MODELOS-CONVERSAO-E-TOKEN.md](./issues/ISSUE-F1-01-002-MODELOS-CONVERSAO-E-TOKEN.md) |
