---
doc_id: "F1_OC-ISSUE-FIRST-FACTORY_EPICS.md"
version: "1.0"
status: "todo"
owner: "PM"
...
# Epicos - OC-ISSUE-FIRST-FACTORY / F1 - Fundacao do projeto
...
- relatorio_mais_recente: `PROJETOS/OC-ISSUE-FIRST-FACTORY/F1-FUNDACAO/auditorias/RELATORIO-AUDITORIA-F1-R01.md`
- log_do_projeto: [PROJETOS/OC-ISSUE-FIRST-FACTORY/AUDIT-LOG.md](../AUDIT-LOG.md)
...
> **Nota de rastreabilidade**: nesta fase, o rotulo **Feature 1** na tabela abaixo e o `EPIC-F1-01` referem-se a **fundacao do projeto capability** (scaffold), nao a "Feature 1: Ingresso Telegram" do PRD. O backlog Telegram/bootstrap no **repositorio alvo** usa os IDs `EPIC-ALVO-*` e `ISSUE-ALVO-*` descritos no PRD (secao 14).
