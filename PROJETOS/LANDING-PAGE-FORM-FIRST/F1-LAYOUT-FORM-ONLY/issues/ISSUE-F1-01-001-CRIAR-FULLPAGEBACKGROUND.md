...
- [ ] componente FullPageBackground criado em `frontend/src/components/landing/`
- [ ] gradiente correto para os 7 templates conforme PRD secao 05
- [ ] fundo preenche 100vw × 100vh sem gap
- [ ] nenhuma imagem externa carregada para o fundo

## Tarefas Decupadas

- [ ] T1: criar arquivo `FullPageBackground.tsx` com props para receber dados do tema
- [ ] T2: mapear gradientes dos 7 templates a partir dos tokens de `buildLandingTheme`
- [ ] T3: aplicar gradiente como `background` do wrapper com `position: fixed`, `inset: 0`
- [ ] T4: exportar slot para children (card, footer) e para overlay grafico
- [ ] T5: validar visualmente em pelo menos 3 templates (corporativo, esporte_radical, generico)
