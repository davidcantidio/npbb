...
feature_slug: "CONFIGURACAO-POR-EVENTO-DAS-CATEGORIAS-INICIAIS"
...
# FEATURE-1 - configuracao por evento das categorias iniciais `pista`, `pista premium` e `camarote`
...
- **Problema que esta feature resolve**: configuracao por evento das categorias iniciais `pista`, `pista premium` e `camarote`
- **Resultado de negocio esperado**: entregar um recorte executavel do PRD sem depender de backlog monolitico

## 2. Comportamento Esperado

- habilitar configuracao por evento das categorias iniciais `pista`, `pista premium` e `camarote`
...
|---|---|---|---|---|---|
| US-1-01 | configuracao por evento das categorias iniciais `pista`, `pista premium` e `camarote` | 3 | - | todo | `user-stories/US-1-01-CONFIGURACAO-POR-EVENTO-DAS-CATEGORIAS-INICIAIS/README.md` |
