...
- Contagem identica de `lead`, `evento` e `usuario`: pendente.
- `alembic upgrade head` sem erros: pendente.
- Validacao de integridade relacional e leituras essenciais: pendente.
...
| `EPIC-F2-02` | `todo` | `artifacts/phase-f2/epic-f2-02-validacao-integridade-dados.md` |
