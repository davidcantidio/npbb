...
def upgrade() -> None:
    ...
    if not insp.has_table("scraping_runs"):
        op.create_table(
            "scraping_runs",
            sa.Column("id", sa.Integer(), nullable=False),
    ...
    if not insp.has_table("scraping_social_posts"):
        op.create_table(
    ...
    if not insp.has_table("scraping_post_hashtags"):
        op.create_table(
    ...
    if not insp.has_table("scraping_post_mentions"):
        op.create_table(
    ...
    if not insp.has_table("scraping_post_coauthors"):
        op.create_table(
    ...
    if not insp.has_table("scraping_profile_snapshots"):
        op.create_table(
    ...
    if not insp.has_table("scraping_indicators_snapshot"):
        op.create_table(
    ...
    if not insp.has_table("scraping_indicators_monthly"):
        op.create_table(
        ...
        op.create_index(
            "ix_scraping_indicators_monthly_month", "scraping_indicators_monthly", ["month"], unique=False
        )
