...
Decidir formalmente o papel de `PROMPT-PLANEJAR-FASE.md` e alinhar a sessao de
planejamento ao caminho escolhido.

## Resultado de Negocio Mensuravel

`SESSION-PLANEJAR-PROJETO.md` aponta para uma referencia suportada e a decisao
fica registrada em `GOV-DECISOES.md`.

## Contexto Arquitetural

- afeta `PROMPT-PLANEJAR-FASE.md`
- afeta `SESSION-PLANEJAR-PROJETO.md`
- afeta `GOV-DECISOES.md`
