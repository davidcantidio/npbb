...
| EPIC-F1-03 | Unificacao de Responsabilidades e Eliminacao de Drift | Consolidar regras, links e referencias normativas. | EPIC-F1-01 | todo | [EPIC-F1-03-UNIFICACAO-DE-RESPONSABILIDADES-E-ELIMINACAO-DE-DRIFT.md](./EPIC-F1-03-UNIFICACAO-DE-RESPONSABILIDADES-E-ELIMINACAO-DE-DRIFT.md) |
...
- [ ] todos os artefatos de `PROJETOS/COMUM/` seguem a convencao nova
- [ ] referencias antigas em projetos ativos foram corrigidas
- [ ] `source_mode: backfilled` possui regra operacional
- [ ] template de fase inclui checklist de transicao de gate
