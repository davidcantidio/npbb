...
project: "PIPELINE-LEGACY"
feature_key: "FEATURE-1"
feature_slug: "CAPTURA-LEGADA"
prd_path: "../../PRD-PIPELINE-LEGACY.md"
intake_path: "../../INTAKE-PIPELINE-LEGACY.md"
depende_de: []
...
# FEATURE-1 - Captura legada

## 0. Rastreabilidade

- **Projeto**: `PIPELINE-LEGACY`
- **PRD**: [PRD-PIPELINE-LEGACY.md](../../PRD-PIPELINE-LEGACY.md)
- **Intake**: [INTAKE-PIPELINE-LEGACY.md](../../INTAKE-PIPELINE-LEGACY.md)
- **depende_de**: []
- **Evidencia no PRD**: Escopo/Dentro: Captura legada
...
|---|---|---|---|---|---|
| US-1-07 | Seed legado | 2 | - | todo | `user-stories/US-1-07-SEED-LEGADO/README.md` |
