...
|---|---|---|---|---|---|
| EPIC-F3-01 | Registro e Validacao dos Prompts Antecipados | Formalizar o mapa de sessao e revisar os prompts ja existentes. | F1 done | active | [EPIC-F3-01-REGISTRO-E-VALIDACAO-DOS-PROMPTS-ANTECIPADOS.md](./EPIC-F3-01-REGISTRO-E-VALIDACAO-DOS-PROMPTS-ANTECIPADOS.md) |
