...
- `TEMPLATE-AUDITORIA-RELATORIO.md` permanece apenas como stub de
  compatibilidade historica; o artefato completo do fluxo issue-first saiu do
  clone lean junto com o baseline `GOV-ISSUE-FIRST.md`
...
- nova entrada em `AUDIT-LOG.md` — preferir edicao incremental (encoding UTF-8,
  LF); ver `PROJETOS/COMUM/SPEC-EDITOR-ARTEFACTOS.md`
...
- regra operacional para OpenClaw multi-agente: usar o modelo configurado em
  `FABRICA_AUDITOR_MODEL`, acessado via OpenRouter, como agente senior de
