...
| 3    | Senha                  | Password             | Sim               | Campo protegido                                                            |
...
| Verificar email (opcional) | `/usuarios/check-email?email=...` | GET    | Checa disponibilidade                           |
...
- Qual política de senha será exigida (mínimo de caracteres, complexidade)?
- Haverá verificação por e-mail (link de ativação)?
...
- [ ] Retornar erros claros (400/409) com mensagens específicas
