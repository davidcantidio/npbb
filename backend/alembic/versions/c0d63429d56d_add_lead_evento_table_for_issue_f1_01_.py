...
def upgrade() -> None:
    ...
    sa.Column('doc_id', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=False),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'INTAKE', 'PRD', 'PLANNING', 'EXECUTION', 'AUDIT', 'COMPLETED', 'CANCELLED', name='projectstatus'), nullable=True),
    sa.Column('agent_mode', sa.Enum('HUMAN_IN_LOOP', 'SEMI_AUTONOMOUS', 'FULLY_AUTONOMOUS', name='agentmode'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['intake_id'], ['framework_intake.id'], name=op.f('fk_framework_project_intake_id_framework_intake')),
    sa.ForeignKeyConstraint(['prd_id'], ['framework_prd.id'], name=op.f('fk_framework_project_prd_id_framework_prd')),
    ...
    sa.Column('output_generated', sa.Text(), nullable=True),
    sa.Column('agent_model', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
    sa.Column('tokens_used', sa.Integer(), nullable=True),
    sa.Column('duration_ms', sa.Integer(), nullable=True),
    sa.Column('success', sa.Boolean(), nullable=False),
    sa.Column('human_approval', sa.Enum('PENDING', 'APPROVED', 'REJECTED', 'AUTO_APPROVED', name='approvalstatus'), nullable=True),
    sa.Column('approved_by', sqlmodel.sql.sqltypes.AutoString(length=100), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('metadata_json', sa.JSON(), nullable=True),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'INTAKE', 'PRD', 'PLANNING', 'EXECUTION', 'AUDIT', 'COMPLETED', 'CANCELLED', name='projectstatus'), nullable=False),
    sa.Column('audit_gate', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False),
    ...
    sa.Column('epic_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('title', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('status', sqlmodel.sql.sqltypes.AutoString(length=20), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
