...
|---|---|---|---|---|---|
| EPIC-F3-01 | Validar backend e scripts criticos contra Supabase | Confirmar runtime, scripts e invariantes minimos apos a migracao de dados | F2 concluida | done | [EPIC-F3-01-Validar-Backend-e-Scripts-Criticos-contra-Supabase.md](./EPIC-F3-01-Validar-Backend-e-Scripts-Criticos-contra-Supabase.md) |
| EPIC-F3-02 | Consolidar configuracao final e remover dependencia do Postgres local | Atualizar setup, troubleshooting e deploy para Supabase como banco unico | EPIC-F3-01 | done | [EPIC-F3-02-Consolidar-Configuracao-Final-e-Remover-Dependencia-do-Postgres-Local.md](./EPIC-F3-02-Consolidar-Configuracao-Final-e-Remover-Dependencia-do-Postgres-Local.md) |
