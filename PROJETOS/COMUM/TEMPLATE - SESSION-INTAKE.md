...
# SESSION-INTAKE — Criação de Intake em Sessão de Chat
...
Leia também `PROJETOS/COMUM/INTAKE-TEMPLATE.md` como estrutura canônica do artefato
a ser produzido e `PROJETOS/COMUM/INTAKE-FRAMEWORK.md` como critério de prontidão
para PRD.
...
Preencha o `INTAKE-TEMPLATE.md` com todos os campos respondidos e inferidos.
...
O `AUDIT-LOG.md` deve ser gerado a partir de `PROJETOS/COMUM/AUDITORIA-LOG-TEMPLATE.md`
