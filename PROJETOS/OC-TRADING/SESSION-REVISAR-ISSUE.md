...
Usar este wrapper apenas quando uma issue real da vertical entrar em `ready_for_review`.
...
OBSERVACOES:    o bootstrap F1 ja esta reconciliado; reutilize este wrapper apenas para backlog Trading real
```

## Regra Local Adicional

No estado atual do projeto nao existe issue real pendente de review. O proximo passo e planning.
