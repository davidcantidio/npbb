...
TASK_PATH:  <caminho completo para PROJETOS/OPENCLAW-MIGRATION/features/.../TASK-N.md>
ROUND:      1
```

## Regra Local Adicional

- prefira esta sessao quando a task alvo ja for conhecida; use `SESSION-IMPLEMENTAR-US.md` com `TASK_ID: auto` quando a fila ainda tiver de ser resolvida na US
- nao reintroduza `ISSUE-*` ou `FASE` como superficie operacional
