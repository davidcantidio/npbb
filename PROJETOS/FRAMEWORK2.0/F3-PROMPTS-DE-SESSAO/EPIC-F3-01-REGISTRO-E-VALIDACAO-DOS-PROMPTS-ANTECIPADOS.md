...
Formalizar `SESSION-MAPA.md` e revalidar os prompts ja existentes apos a
renomeacao e consolidacao normativa de F1.

## Resultado de Negocio Mensuravel

Os prompts de sessao existentes passam a refletir o estado atual do framework
e deixam de apontar para nomes ou regras obsoletas.

## Contexto Arquitetural

- afeta `SESSION-MAPA.md`
- afeta `SESSION-CRIAR-INTAKE.md`
- afeta `SESSION-PLANEJAR-PROJETO.md`

## Definition of Done do Epico

- [ ] mapa de sessoes formalizado
- [ ] prompts antecipados revistos no estado pos-F1
