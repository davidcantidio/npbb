...
def upgrade() -> None:
    ...
    if not insp.has_table("sponsored_institution"):
        op.create_table(
    ...
    # 3. social_profile
    if not insp.has_table("social_profile"):
        op.create_table(
            "social_profile",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
    ...
    # 4. sponsorship_group
    if not insp.has_table("sponsorship_group"):
        op.create_table(
            "sponsorship_group",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column("name", sa.String(200), nullable=False),
    ...
    # 5. group_member
    if not insp.has_table("group_member"):
        op.create_table(
            "group_member",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
    ...
    if not insp.has_table("sponsorship_contract"):
        op.create_table(
    ...
    # 7. contract_clause
    if not insp.has_table("contract_clause"):
        op.create_table(
            "contract_clause",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
    ...
    if not insp.has_table("counterpart_requirement"):
        op.create_table(
    ...
    if not insp.has_table("requirement_occurrence"):
        op.create_table(
    ...
    if not insp.has_table("occurrence_responsible"):
        op.create_table(
    ...
    # 11. delivery
    if not insp.has_table("delivery"):
        op.create_table(
            "delivery",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
            sa.Column("occurrence_id", sa.Integer(), sa.ForeignKey("requirement_occurrence.id"), nullable=False, index=True),
    ...
    if not insp.has_table("delivery_evidence"):
        op.create_table(
            "delivery_evidence",
            sa.Column("id", sa.Integer(), primary_key=True, autoincrement=True),
    ...
    if not insp.has_table("contract_extraction_draft"):
        op.create_table(
