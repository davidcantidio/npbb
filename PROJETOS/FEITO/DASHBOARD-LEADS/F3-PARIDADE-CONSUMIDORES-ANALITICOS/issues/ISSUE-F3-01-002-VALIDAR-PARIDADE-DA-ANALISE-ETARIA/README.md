---
doc_id: "ISSUE-F3-01-002-VALIDAR-PARIDADE-DA-ANALISE-ETARIA.md"
version: "1.0"
status: "todo"
owner: "PM"
...
# ISSUE-F3-01-002 - Validar paridade da analise etaria

## User Story

Como mantenedor do modulo de leads e dashboards, quero validar paridade da analise etaria para que a remediacao do vinculo canonico fique consistente e auditavel dentro de `EPIC-F3-01`.
...
- Red: escrever ou ajustar testes focados nos contratos diretamente afetados por `ISSUE-F3-01-002` usando `cd backend && PYTHONPATH=.. SECRET_KEY=ci-secret-key TESTING=true python3 -m pytest -q tests/test_dashboard_age_analysis_endpoint.py` como comando alvo.
...
- Given os arquivos alvo de `ISSUE-F3-01-002`, When a issue for concluida, Then existe evidencias de paridade e nao regressao para a analise etaria sobre fixtures canonicas.
...
- [Issue Dependente](../ISSUE-F3-01-001-CONSOLIDAR-ANALISE-ETARIA-NO-CAMINHO-CANONICO/README.md)
