...
feature_slug: "INVENTARIO-RECONCILIADO-ENTRE-PLANEJADO-E-RECEBIDO"
...
# FEATURE-3 - inventario reconciliado entre `planejado` e `recebido_confirmado`
...
- **Problema que esta feature resolve**: inventario reconciliado entre `planejado` e `recebido_confirmado`
- **Resultado de negocio esperado**: entregar um recorte executavel do PRD sem depender de backlog monolitico

## 2. Comportamento Esperado

- habilitar inventario reconciliado entre `planejado` e `recebido_confirmado`
...
|---|---|---|---|---|---|
| US-3-01 | inventario reconciliado entre `planejado` e `recebido_confirmado` | 3 | - | todo | `user-stories/US-3-01-INVENTARIO-RECONCILIADO-ENTRE-PLANEJADO-E-RECEBIDO/README.md` |
