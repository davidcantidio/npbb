---
doc_id: "ISSUE-F3-02-002-CONSOLIDAR-DASHBOARD-LEADS-RELATORIO.md"
version: "1.0"
status: "todo"
owner: "PM"
...
# ISSUE-F3-02-002 - Consolidar /dashboard/leads/relatorio
...
- Red: escrever ou ajustar testes focados nos contratos diretamente afetados por `ISSUE-F3-02-002` usando `cd backend && PYTHONPATH=.. SECRET_KEY=ci-secret-key TESTING=true python3 -m pytest -q tests/test_dashboard_leads_report_endpoint.py` como comando alvo.
...
- Given os arquivos alvo de `ISSUE-F3-02-002`, When a issue for concluida, Then o relatorio agregado preserva payload e filtros atuais apoiado na base canonica.
