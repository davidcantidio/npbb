...
feature_slug: "BLOQUEIO-DE-DISTRIBUICAO-QUANDO-AUMENTO-EXTERNO"
...
# FEATURE-4 - bloqueio de distribuicao quando aumento externo ainda nao tiver sido recebido
...
- **Problema que esta feature resolve**: bloqueio de distribuicao quando aumento externo ainda nao tiver sido recebido
- **Resultado de negocio esperado**: entregar um recorte executavel do PRD sem depender de backlog monolitico

## 2. Comportamento Esperado

- habilitar bloqueio de distribuicao quando aumento externo ainda nao tiver sido recebido
...
|---|---|---|---|---|---|
| US-4-01 | bloqueio de distribuicao quando aumento externo ainda nao tiver sido recebido | 3 | - | todo | `user-stories/US-4-01-BLOQUEIO-DE-DISTRIBUICAO-QUANDO-AUMENTO-EXTERNO/README.md` |
