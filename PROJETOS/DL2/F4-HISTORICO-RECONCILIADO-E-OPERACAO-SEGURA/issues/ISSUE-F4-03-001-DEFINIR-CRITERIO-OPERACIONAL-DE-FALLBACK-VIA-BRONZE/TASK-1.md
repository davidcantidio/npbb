---
doc_id: "TASK-1.md"
issue_id: "ISSUE-F4-03-001-DEFINIR-CRITERIO-OPERACIONAL-DE-FALLBACK-VIA-BRONZE"
task_id: "T1"
version: "1.0"
status: "todo"
owner: "PM"
...
- `rg -n "reprocess|bronze|silver|gold" backend/app/routers/ingestao_inteligente.py backend/app/models/lead_batch.py PROJETOS/DL2/PRD-DL2.md`
- `rg -n "lead_evento|LeadEvento|LeadEventoSourceKind|AtivacaoLead|evento_nome|lead_batch|manual_reconciled|dashboard" backend/app/routers/ingestao_inteligente.py backend/app/models/lead_batch.py PROJETOS/DL2/PRD-DL2.md`
