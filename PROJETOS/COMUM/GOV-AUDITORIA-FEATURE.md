...
- `PROJETOS/COMUM/TEMPLATE-AUDITORIA-RELATORIO.md` permanece apenas como stub
  de compatibilidade historica; o artefato completo do fluxo issue-first saiu
  do clone lean e nao e template ativo do v3.0
