...
import { listDiretorias, listEventos, type Diretoria as DiretoriaAdmin, type EventoListItem } from "../services/eventos";
import {
...
function IngressosPortalBB({ token }: PortalProps) {
    ...
    return (
      <Paper elevation={2} sx={{ p: 3, borderRadius: 2 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Faça login novamente para solicitar ingressos.
        </Typography>
      </Paper>
    );
  }
  ...
  if (!token) {
    return (
      <Paper elevation={2} sx={{ p: 3, borderRadius: 2 }}>
        ...
        <Typography variant="body2" color="text.secondary">
          Faça login novamente para visualizar as solicitacoes.
        </Typography>
      </Paper>
    );
  }
...
export default function IngressosPortal() {
  ...
  return <IngressosPortalAdmin token={token} />;
}
