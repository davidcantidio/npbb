...
> Documento legado. Mantido apenas como referencia para artefatos historicos
> que ainda preservam `SPRINT-*.md`. O modelo canonico ativo do framework v3.0
> nao usa sprint como superficie operacional principal.
