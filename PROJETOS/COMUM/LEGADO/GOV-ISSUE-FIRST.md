...
> Documento legado. Mantido apenas como referencia historica e compatibilidade
> documental. O modelo canonico ativo do framework v3.0 e
> `Intake -> Clarificacao -> PRD -> Features -> User Stories -> Tasks -> Execucao -> Review -> Auditoria de Feature`.
> Para trabalho novo, use `GOV-FRAMEWORK-MASTER.md`, `GOV-PRD.md`,
> `GOV-FEATURE.md`, `GOV-USER-STORY.md` e `TEMPLATE-TASK.md`.
