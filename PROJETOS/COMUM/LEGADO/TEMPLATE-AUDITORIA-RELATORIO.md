...
> Template legado de compatibilidade para `GOV-ISSUE-FIRST.md` e auditorias
> historicas de fase/projeto. Nao usar no fluxo canonico feature-first do v3.0;
> para novas auditorias de feature, use `TEMPLATE-AUDITORIA-FEATURE.md`.
