...
- [x] governanca de auditoria apontando para o spec
...
| ISSUE-F2-01-003 | Integrar spec anti-monolito a governanca de auditoria | Fazer a auditoria consumir o spec como fonte de threshold. | 2 | done | [ISSUE-F2-01-003-INTEGRAR-SPEC-ANTI-MONOLITO-A-GOVERNANCA-DE-AUDITORIA.md](./issues/ISSUE-F2-01-003-INTEGRAR-SPEC-ANTI-MONOLITO-A-GOVERNANCA-DE-AUDITORIA.md) |
