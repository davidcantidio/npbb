"""Operational service for XIA Sprint 1 AI extraction scaffold flow.
...
def execute_s1_extract_ai_service(
    ...
    """Execute XIA Sprint 1 scaffold service with actionable diagnostics.
    ...
    Raises:
        S1AIExtractServiceError: If scaffold validation fails or an unexpected
    ...
    try:
        ...
        logger.warning(
            "etl_extract_ai_s1_scaffold_error",
            extra={
                "correlation_id": correlation_id,
        ...
        raise S1AIExtractServiceError(
            ...
            message=f"Falha ao executar fluxo XIA S1: {type(exc).__name__}",
