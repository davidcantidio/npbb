...
- [ ] POST /leads aceita ativacao_id quando acesso via ativação
- [ ] Conversão registrada em conversao_ativacao
- [ ] Ativação única: bloqueio retorna bloqueado_cpf_duplicado = true
- [ ] Frontend exibe mensagem clara quando bloqueado
- [ ] Testes backend e Playwright cobrindo cenários
