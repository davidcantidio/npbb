...
def test_age_analysis_response_serialization():
    payload = AgeAnalysisResponse(
        ...
        consolidado=ConsolidadoAgeAnalysis(
            ...
            faixa_dominante_status="resolved",
            clientes_bb_base_idade_volume=6,
            clientes_bb_faixa_18_40_volume=4,
            clientes_bb_faixa_18_40_pct=66.67,
            clientes_bb_fora_18_40_volume=2,
            clientes_bb_fora_18_40_pct=33.33,
            nao_clientes_bb_base_idade_volume=3,
            nao_clientes_bb_faixa_18_40_volume=2,
            nao_clientes_bb_faixa_18_40_pct=66.67,
            nao_clientes_bb_fora_18_40_volume=1,
            nao_clientes_bb_fora_18_40_pct=33.33,
        ),
