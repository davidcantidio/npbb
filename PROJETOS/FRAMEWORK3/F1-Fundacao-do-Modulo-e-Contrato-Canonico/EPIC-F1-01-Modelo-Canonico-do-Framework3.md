...
- [x] regressao atual do backend registrada e encapsulada na primeira issue executavel
- [x] modelo schemas e migration do dominio alinhados ao contrato canonico aprovado
- [x] issues do epic concluida sem ambiguidade residual sobre entidades e estados
