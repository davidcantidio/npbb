...
- prompt canonico: `PROJETOS/COMUM/AUDITORIA-PROMPT.md`
- template de relatorio: `PROJETOS/COMUM/AUDITORIA-REPORT-TEMPLATE.md`
- template de log: `PROJETOS/COMUM/AUDITORIA-LOG-TEMPLATE.md`
