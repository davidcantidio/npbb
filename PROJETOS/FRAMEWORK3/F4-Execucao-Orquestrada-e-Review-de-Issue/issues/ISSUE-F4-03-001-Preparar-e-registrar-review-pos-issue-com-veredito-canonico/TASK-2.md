...
# TASK-2 - Entregar UI de review pos-issue

## objetivo

permitir ao PM revisar diff evidencias e enviar o veredito da issue
...
- testes_a_escrever_primeiro:
  - cobrir exibicao de evidencias selecao de veredito e envio da review
- comando_para_rodar:
  - `cd frontend && npm run test -- --run src/pages/framework/__tests__/FrameworkIssueReviewPage.test.tsx`
...
Review pos-issue operacional na UI.
...
- parar se a UI depender de visualizador de diff nao previsto no escopo
