...
Historicamente o índice derivado materializava-se em SQLite (`scripts/fabrica_projects_index/schema.sql`, `PRAGMA user_version = 4`), com FTS5 embutido e `embeddings.embedding` como BLOB. Isso limitava:
...
**Operacao de sync e matriz quando o DB e obrigatorio:** ver
`SPEC-RUNTIME-POSTGRES-MATRIX.md` e `scripts/fabrica_projects_index/README.md`.
