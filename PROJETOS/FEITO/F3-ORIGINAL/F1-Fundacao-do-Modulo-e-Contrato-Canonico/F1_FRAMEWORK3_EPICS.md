...
|---|---|---|---|---|---|
| EPIC-F1-01 | Modelo Canonico do Framework3 | Consolidar o dominio canonico do FRAMEWORK3 e estabilizar a baseline tecnica do embriao ja presente no backend. | nenhuma | done | [EPIC-F1-01-Modelo-Canonico-do-Framework3.md](./EPIC-F1-01-Modelo-Canonico-do-Framework3.md) |
