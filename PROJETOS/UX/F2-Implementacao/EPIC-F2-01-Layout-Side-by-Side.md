...
- [x] Layout de duas colunas em todas as 5 etapas
- [x] Breakpoint implementado (colapso para coluna unica conforme F1)
- [x] Padrao visual consistente (respiro, fontes, espacamentos)

## Issues do Epico

| Issue ID | Nome | Objetivo | SP | Status | Documento |
|---|---|---|---|---|---|
| ISSUE-F2-01-001 | Converter Layout para Duas Colunas | Aplicar layout side-by-side em todas as 5 etapas | 3 | done | [ISSUE-F2-01-001-Converter-Layout-Duas-Colunas.md](./issues/ISSUE-F2-01-001-Converter-Layout-Duas-Colunas.md) |
| ISSUE-F2-01-002 | Implementar Breakpoint para Viewports Menores | Colapso para coluna unica abaixo do breakpoint | 2 | done | [ISSUE-F2-01-002-Implementar-Breakpoint-Viewports-Menores.md](./issues/ISSUE-F2-01-002-Implementar-Breakpoint-Viewports-Menores.md) |
