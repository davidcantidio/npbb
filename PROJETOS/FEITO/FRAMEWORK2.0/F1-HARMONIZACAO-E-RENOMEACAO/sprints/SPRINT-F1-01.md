...
Fechar a base da renomeacao, estabilizar o entrypoint autonomo e abrir a decisao
estrutural sobre o prompt de planejamento.
...
- blast radius da renomeacao em `PROJETOS/COMUM/`
- risco de quebrar referencias sem fechar a passada em projetos ativos
