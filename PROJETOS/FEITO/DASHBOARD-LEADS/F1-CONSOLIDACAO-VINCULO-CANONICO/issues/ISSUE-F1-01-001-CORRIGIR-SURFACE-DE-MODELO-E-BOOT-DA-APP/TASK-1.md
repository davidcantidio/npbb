---
doc_id: "TASK-1.md"
issue_id: "ISSUE-F1-01-001-CORRIGIR-SURFACE-DE-MODELO-E-BOOT-DA-APP"
task_id: "T1"
version: "1.0"
status: "todo"
owner: "PM"
...
# T1 - Corrigir surface de modelo e boot da app

## objetivo

Reexportar `LeadEvento` e `LeadEventoSourceKind` no agregado de modelos e remover o erro de import que hoje impede a coleta da suite.
...
- testes_a_escrever_primeiro:
  - cobrir o contrato principal de `ISSUE-F1-01-001` no modulo alvo
...
- coleta de `tests/test_dashboard_leads_endpoint.py` e `tests/test_dashboard_leads_report_endpoint.py` sem erro de import
